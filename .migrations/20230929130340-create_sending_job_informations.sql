-- 送客先エージェントの求人情報を管理するテーブル(※job_informationsから非公開先設定、備考・手数料、選考情報を除外して求人企業名を追加した項目)
-- +migrate Up
CREATE TABLE IF NOT EXISTS sending_job_informations (
    id INT AUTO_INCREMENT NOT NULL UNIQUE,                -- 重複しないID
    uuid CHAR(36) NOT NULL UNIQUE,                        -- 重複しないカラム毎のUUID
    sending_billing_address_id	INT NOT NULL,	            -- 請求先のID
    company_name  VARCHAR(255) NOT NULL,	                -- 求人企業名
    ...
    other_required	TEXT NOT NULL,	                      -- その他の必要資格
    ...
    PRIMARY KEY(id),
    INDEX idx_sending_job_informations_sending_billing_address_id (sending_billing_address_id),
    FULLTEXT idx_sending_job_informations_title (title) WITH PARSER ngram
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

ALTER TABLE sending_job_informations
    ADD CONSTRAINT fk_sending_job_informations_sending_billing_address_id
...
-- +migrate Down
ALTER TABLE sending_job_informations DROP FOREIGN KEY fk_sending_job_informations_sending_billing_address_id;

DROP TABLE IF EXISTS sending_job_informations;