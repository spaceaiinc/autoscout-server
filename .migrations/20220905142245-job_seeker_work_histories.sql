-- 求職者の職歴を管理するテーブル
-- +migrate Up
CREATE TABLE IF NOT EXISTS job_seeker_work_histories (
    ...
    PRIMARY KEY(id),
    INDEX idx_job_seeker_work_histories_job_seeker_id (job_seeker_id)
);

ALTER TABLE job_seeker_work_histories
    ADD CONSTRAINT fk_job_seeker_work_histories_job_seeker_id
...
-- +migrate Down
ALTER TABLE job_seeker_work_histories DROP FOREIGN KEY fk_job_seeker_work_histories_job_seeker_id;

DROP TABLE IF EXISTS job_seeker_work_histories;