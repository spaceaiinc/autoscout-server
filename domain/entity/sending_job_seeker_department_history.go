...
type SendingJobSeekerDepartmentHistory struct {
	...
	ExperienceOccupations []SendingJobSeekerExperienceOccupation `db:"experience_occupations" json:"experience_occupations"`
}

func NewSendingJobSeekerDepartmentHistory(
	workHistoryID uint,
	department string,
	...
	startYear string,
	endYear string,
) *SendingJobSeekerDepartmentHistory {
	return &SendingJobSeekerDepartmentHistory{
