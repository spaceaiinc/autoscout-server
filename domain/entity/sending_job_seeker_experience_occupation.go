...
type SendingJobSeekerExperienceOccupation struct {
...
func NewSendingJobSeekerExperienceOccupation(
	departmentHistoryID uint,
	occupation null.Int,
) *SendingJobSeekerExperienceOccupation {
	return &SendingJobSeekerExperienceOccupation{
