...
/****************************************************************************************/
// 送客先エージェント
type SendingEnterpriseRepository interface {
	/** 作成 */
	// 送客先エージェントを作成する
	Create(sendingEnterprise *entity.SendingEnterprise) error

	/** 更新 */
	// 送客先エージェントを更新する
	Update(sendingEnterprise *entity.SendingEnterprise, sendingEnterpriseID uint) error

	// 送客先エージェントのパスワードを更新する
	UpdatePassword(sendingEnterpriseID uint, password string) error

	/** 削除 */
	// 送客先エージェントを削除する
	Delete(sendingEnterpriseID uint) error

	/** 単数取得 */
	// 指定のIDの送客先エージェントを取得する
	FindByID(sendingEnterpriseID uint) (*entity.SendingEnterprise, error)

	// 指定のUUIDの送客先エージェントを取得する
	FindByUUID(uuid uuid.UUID) (*entity.SendingEnterprise, error)

	/** 複数取得 */
	// 指定のenterpriseIDListに合致する送客先エージェントをすべて取得する
	GetByIDList(enterpriseIDList []uint) ([]*entity.SendingEnterprise, error)

	// 指定IDの求職者をまだ送客していない企業とその求人数をすべて取得する
	GetSendingEnterpriseAndJobInfoCountByHaveNotSentYetBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingEnterprise, error)

	// 指定IDの求職者をまだ送客していない企業をすべて取得する
	GetSendingEnterpriseByHaveNotSentYetBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingEnterprise, error)

	// 全てのレコードを取得
	All() ([]*entity.SendingEnterprise, error)
}

// 送客先エージェントの参考資料
type SendingEnterpriseReferenceMaterialRepository interface {
	/** 作成 */
	// 送客先エージェントの参考資料を作成する
	Create(referenceMaterial *entity.SendingEnterpriseReferenceMaterial) error

	/** 更新 */
	// 送客先エージェントの参考資料を更新する
	Update(referenceMaterial *entity.SendingEnterpriseReferenceMaterial) error

	// fileTypeに合わせて送客先エージェントのreference_pdf_urlを更新する
	UpdateReferenceURLBySendingEnterpriseIDAndMaterialType(sendingEntepriseID uint, fileType string) error

	/** 単数取得 */
	// 指定のSendingEnterpriseIDで送客先エージェントの参考資料を取得する
	FindBySendingEnterpriseID(sendingEnterpriseID uint) (*entity.SendingEnterpriseReferenceMaterial, error)

	/** 複数取得 */
	// 全てのレコードを取得
	All() ([]*entity.SendingEnterpriseReferenceMaterial, error)
}

// 送客先エージェントの「エージェントの特徴」を管理するテーブル *1エージェントにつき1レコード
type SendingEnterpriseSpecialityRepository interface {
	/** 作成 */
	// 送客先エージェントの「エージェントの特徴」を管理するテーブルを作成する
	Create(speciality *entity.SendingEnterpriseSpeciality) error

	/** 更新 */
	// 送客先エージェントの「エージェントの特徴」を管理するテーブルを更新する
	Update(speciality *entity.SendingEnterpriseSpeciality) error

	// sendingEnterpriseIDの送客先エージェントの「エージェントの特徴」を管理するテーブルのimage_urlを更新する
	UpdateImageURLBySendingEnterpriseID(sendingEnterpriseID uint, imageURL string) error

	/** 単数取得 */
	// 指定のSendingEnterpriseIDで送客先エージェントの「エージェントの特徴」を管理するテーブルを取得する
	FindBySendingEnterpriseID(sendingEnterpriseID uint) (*entity.SendingEnterpriseSpeciality, error)
}
...
/// 送客先エージェントの請求情報
//
type SendingBillingAddressRepository interface {
	/** 作成 */
	// 送客先エージェントの請求情報を作成する
	Create(billingAddress *entity.SendingBillingAddress) error

	/** 更新 */
	// 送客先エージェントの請求情報を更新する
	Update(billingAddress *entity.SendingBillingAddress, billingAddressID uint) error
	...
	/** 単数取得 */
	// 指定のIDの送客先エージェントの請求情報を取得する
	FindByID(billingAddressID uint) (*entity.SendingBillingAddress, error)

	// 指定のIDの送客先エージェントの請求情報を取得する
	FindBySendingEnterpriseID(enterpriseID uint) (*entity.SendingBillingAddress, error)

	/** 複数取得 */
	// 指定のIDListの送客先エージェントの請求情報をすべて取得する
	GetByIDList(billingAddressIDList []uint) ([]*entity.SendingBillingAddress, error)

	// 指定のEnterpriseIDListの送客先エージェントの請求情報をすべて取得する
	GetBySendingEnterpriseIDList(enterpriseIDList []uint) ([]*entity.SendingBillingAddress, error)

	// 全てのレコードを取得
	All() ([]*entity.SendingBillingAddress, error)
}

// / 送客先エージェントの請求先の担当者情報
type SendingBillingAddressStaffRepository interface {
	/** 作成 */
	// 送客先エージェントの請求先の担当者情報を作成する
	Create(staff *entity.SendingBillingAddressStaff) error

	/** 削除 */
	// 送客先エージェントの請求先の担当者情報を削除する
	Delete(billingAddressID uint) error

	/** 単数取得 */
	// 指定のIDの送客先エージェントの請求先の担当者情報を取得する
	FindBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingBillingAddressStaff, error)

	/** 複数取得 */
	// 指定のagentIDの送客先エージェントの請求先の担当者情報をすべて取得する
	GetByAgentID(agentID uint) ([]*entity.SendingBillingAddressStaff, error)

	// 指定のIDListの送客先エージェントの請求先の担当者情報をすべて取得する
	GetByBillingAdressIDList(billingAddressIDList []uint) ([]*entity.SendingBillingAddressStaff, error)

	// 全てのレコードを取得
	All() ([]*entity.SendingBillingAddressStaff, error)
}
...
/// 求人関連
//
type SendingJobInformationRepository interface {
	/** 汎用系 */
	Create(sendingJobInformation *entity.SendingJobInformation) error
	Update(sendingJobInformation *entity.SendingJobInformation, sendingJobInformationID uint) error
	Delete(sendingJobInformationID uint) error
	DeleteBySendingBillingAddressID(billingAddressID uint) error

	FindByID(sendingJobInformationD uint) (*entity.SendingJobInformation, error)
	FindByUUID(uuid uuid.UUID) (*entity.SendingJobInformation, error)

	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformation, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformation, error)
	GetActiveList() ([]*entity.SendingJobInformation, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformation, error)
	GetListBySendingEnterpriseIDList(enterpriseIDList []uint) ([]*entity.SendingJobInformation, error)
	GetListBySendingEnterpriseIDListAndFreeWord(enterpriseIDStrList []uint, freeWord string) ([]*entity.SendingJobInformation, error)
	GetAll() ([]*entity.SendingJobInformation, error)

	// カウント用
	CountByAgentID(agentID uint) (uint, error)
}

// 募集対象
type SendingJobInformationTargetRepository interface {
	/** 汎用系 */
	Create(target *entity.SendingJobInformationTarget) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationTarget, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationTarget, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationTarget, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationTarget, error) // 取得求人リストのIDリストから募集対象を取得
	GetAll() ([]*entity.SendingJobInformationTarget, error)
}

// 募集職種
type SendingJobInformationOccupationRepository interface {
	/** 汎用系 */
	Create(occupation *entity.SendingJobInformationOccupation) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationOccupation, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationOccupation, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationOccupation, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationOccupation, error) // 取得求人リストのIDリストから募集対象を取得
	GetAll() ([]*entity.SendingJobInformationOccupation, error)
}

// 仕事特徴
type SendingJobInformationFeatureRepository interface {
	/** 汎用系 */
	Create(feature *entity.SendingJobInformationFeature) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationFeature, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationFeature, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationFeature, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationFeature, error) // 取得求人リストのIDリストから仕事特徴を取得
	GetAll() ([]*entity.SendingJobInformationFeature, error)
}

// 都道府県
type SendingJobInformationPrefectureRepository interface {
	/** 汎用系 */
	Create(prefecture *entity.SendingJobInformationPrefecture) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationPrefecture, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationPrefecture, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationPrefecture, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationPrefecture, error) // 取得求人リストのIDリストから都道府県を取得
	GetAll() ([]*entity.SendingJobInformationPrefecture, error)
}

// 企業の魅力
type SendingJobInformationWorkCharmPointRepository interface {
	/** 汎用系 */
	Create(workCharmPoint *entity.SendingJobInformationWorkCharmPoint) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationWorkCharmPoint, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationWorkCharmPoint, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationWorkCharmPoint, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationWorkCharmPoint, error) // 取得求人リストのIDリストから企業の魅力を取得
	GetAll() ([]*entity.SendingJobInformationWorkCharmPoint, error)
}

// 雇用形態
type SendingJobInformationEmploymentStatusRepository interface {
	/** 汎用系 */
	Create(employmentStatus *entity.SendingJobInformationEmploymentStatus) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationEmploymentStatus, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationEmploymentStatus, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationEmploymentStatus, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationEmploymentStatus, error) // 取得求人リストのIDリストから雇用形態を取得
	GetAll() ([]*entity.SendingJobInformationEmploymentStatus, error)
}

// 必要条件　requiredCondition
type SendingJobInformationRequiredConditionRepository interface {
	/** 汎用系 */
	Create(requiredCondition *entity.SendingJobInformationRequiredCondition) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredCondition, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredCondition, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredCondition, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredCondition, error) // 取得求人リストのIDリストから必要条件を取得
	GetAll() ([]*entity.SendingJobInformationRequiredCondition, error)
}

// 必要資格
type SendingJobInformationRequiredLicenseRepository interface {
	/** 汎用系 */
	Create(requiredLicense *entity.SendingJobInformationRequiredLicense) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredLicense, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredLicense, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredLicense, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredLicense, error) // 取得求人リストのIDリストから必要資格を取得
	GetAll() ([]*entity.SendingJobInformationRequiredLicense, error)
}

// 必要PCツール
type SendingJobInformationRequiredPCToolRepository interface {
	/** 汎用系 */
	Create(pcTool *entity.SendingJobInformationRequiredPCTool) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredPCTool, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredPCTool, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredPCTool, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredPCTool, error) // 取得求人リストのIDリストからpcToolを取得
	GetAll() ([]*entity.SendingJobInformationRequiredPCTool, error)
}

// 必要言語スキル
type SendingJobInformationRequiredLanguageRepository interface {
	/** 汎用系 */
	Create(requiredLanguage *entity.SendingJobInformationRequiredLanguage) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredLanguage, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredLanguage, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredLanguage, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredLanguage, error) // 取得求人リストのIDリストから必要言語スキルを取得
	GetAll() ([]*entity.SendingJobInformationRequiredLanguage, error)
}

// 必要言語スキルの種類
type SendingJobInformationRequiredLanguageTypeRepository interface {
	/** 汎用系 */
	Create(requiredLanguageType *entity.SendingJobInformationRequiredLanguageType) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredLanguageType, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredLanguageType, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredLanguageType, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredLanguageType, error) // 取得求人リストのIDリストから必要言語スキルを取得
	GetAll() ([]*entity.SendingJobInformationRequiredLanguageType, error)
}

// 必要開発経験
type SendingJobInformationRequiredExperienceDevelopmentRepository interface {
	/** 汎用系 */
	Create(requiredExperienceDevelopment *entity.SendingJobInformationRequiredExperienceDevelopment) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredExperienceDevelopment, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredExperienceDevelopment, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredExperienceDevelopment, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredExperienceDevelopment, error) // 取得求人リストのIDリストから必要開発経験を取得
	GetAll() ([]*entity.SendingJobInformationRequiredExperienceDevelopment, error)
}

// 必要開発経験の種類
type SendingJobInformationRequiredExperienceDevelopmentTypeRepository interface {
	/** 汎用系 */
	Create(requiredExperienceDevelopmentType *entity.SendingJobInformationRequiredExperienceDevelopmentType) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredExperienceDevelopmentType, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredExperienceDevelopmentType, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredExperienceDevelopmentType, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredExperienceDevelopmentType, error) // 取得求人リストのIDリストから必要開発経験を取得
	GetAll() ([]*entity.SendingJobInformationRequiredExperienceDevelopmentType, error)
}

// 必要業界・職種経験
type SendingJobInformationRequiredExperienceJobRepository interface {
	/** 汎用系 */
	Create(requiredExperienceJob *entity.SendingJobInformationRequiredExperienceJob) error
	Delete(experienceJobID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredExperienceJob, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredExperienceJob, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredExperienceJob, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredExperienceJob, error) // 取得求人リストのIDリストから必要業界・職種経験を取得
	GetAll() ([]*entity.SendingJobInformationRequiredExperienceJob, error)
}

// 必要業界経験
type SendingJobInformationRequiredExperienceIndustryRepository interface {
	/** 汎用系 */
	Create(requiredExperienceIndustry *entity.SendingJobInformationRequiredExperienceIndustry) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredExperienceIndustry, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredExperienceIndustry, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredExperienceIndustry, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredExperienceIndustry, error) // 取得求人リストのIDリストから必要業界経験を取得
	GetAll() ([]*entity.SendingJobInformationRequiredExperienceIndustry, error)
}

// 必要職種経験
type SendingJobInformationRequiredExperienceOccupationRepository interface {
	/** 汎用系 */
	Create(requiredExperienceOccupation *entity.SendingJobInformationRequiredExperienceOccupation) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredExperienceOccupation, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredExperienceOccupation, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredExperienceOccupation, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredExperienceOccupation, error) // 取得求人リストのIDリストから必要職種経験を取得
	GetAll() ([]*entity.SendingJobInformationRequiredExperienceOccupation, error)
}

// 必要社会人経験
type SendingJobInformationRequiredSocialExperienceRepository interface {
	/** 汎用系 */
	Create(requiredSocialExperience *entity.SendingJobInformationRequiredSocialExperience) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationRequiredSocialExperience, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationRequiredSocialExperience, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationRequiredSocialExperience, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationRequiredSocialExperience, error) // 取得求人リストのIDリストから必要社会人経験を取得
	GetAll() ([]*entity.SendingJobInformationRequiredSocialExperience, error)
}

// 業界
type SendingJobInformationIndustryRepository interface {
	/** 汎用系 */
	Create(industry *entity.SendingJobInformationIndustry) error
	Delete(sendingJobInformationID uint) error
	GetListBySendingJobInformationID(sendingJobInformationID uint) ([]*entity.SendingJobInformationIndustry, error)
	GetListBySendingBillingAddressID(billingAddressID uint) ([]*entity.SendingJobInformationIndustry, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingJobInformationIndustry, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobInformationIndustry, error) // 取得求人リストのIDリストから募集対象を取得
	GetAll() ([]*entity.SendingJobInformationIndustry, error)
}

/****************************************************************************************/
/****************************************************************************************/
// 送客求職者プロフィール関連(送客元使用)
type SendingCustomerRepository interface {
	/** 汎用系 */
	Create(sendingCustomer *entity.SendingCustomer) error
	Update(id uint, sendingCustomer *entity.SendingCustomer) error
	UpdateDocument(id uint, resumePDFURL, resumeOriginURL, cvPDFURL, cvOriginURL string) error // 書類の更新 *送客時に使用
	UpdateForDev(sendingCustomer *entity.SendingCustomer) error                                // テスト環境用に名前と電話番号を更新
	UpdatePhase(id uint, phase null.Int) error
	UpdateInterviewDate(sendingCustomerID uint, interviewDate time.Time) error
	FindByID(id uint) (*entity.SendingCustomer, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingCustomer, error)
	GetListByAgentIDAndPhase(agentID uint, phase []uint) ([]*entity.SendingCustomer, error)

	// 送客元エージェントの進捗管理情報を取得するためのクエリ(sending_customersテーブル + 送客数を取得)
	GetForSendingCustomerManagement(agentID uint, freeWord string) ([]*entity.SendingCustomer, error)

	// sending_job_seekersテーブルのidを使ってphaseを更新する
	UpdatePhaseBySendingJobSeekerID(sendingJobSeekerID uint, phase null.Int) error
}

// 送客求職者プロフィール関連(送客先使用)
type SendingJobSeekerRepository interface {
	/** 汎用系 */
	Create(sendingJobSeeker *entity.SendingJobSeeker) error

	Update(sendingJobSeeker *entity.SendingJobSeeker, sendingJobSeekerID uint) error
	UpdateForDev(sendingJobSeeker *entity.SendingJobSeeker) error // テスト環境用に名前と電話番号を更新
	UpdatePhase(sendingJobSeekerID uint, phase null.Int) error
	UpdateInterviewDateByCustomerID(sendingCustomerID uint, interviewDate time.Time) error
	UpdateLineID(sendingJobSeekerUUID uuid.UUID, lineID string) error
	UpdateActivityMemo(sendingJobSeekeID uint, activityMemo string) error
	UpdateQuestion(sendingJobSeekeID uint, question string) error
	UpdateAgreement(sendingJobSeekeID uint, agreement bool) error
	UpdateAgentStaffIDBySendingCustomerID(sendingCustomerID, agentStaffID uint) error
	Delete(sendingJobSeekerID uint) error

	FindByID(sendingJobSeekerID uint) (*entity.SendingJobSeeker, error)
	FindByUUID(sendingJobSeekerUUID uuid.UUID) (*entity.SendingJobSeeker, error)
	FindBySendingCustomerID(sendingCustomerID uint) (*entity.SendingJobSeeker, error)                                                // 送客IDから送客求職者を取得
	FindByLineID(sendingJobSeekerLineID string) (*entity.SendingJobSeeker, error)                                                    // Webhookで送られてきたLineIDから求職者を取得
	FindByNameAndPhoneNumber(firstName, lastName, firstFurigana, lastFurigana, phoneNumber string) (*entity.SendingJobSeeker, error) // 送客の重複登録判定

	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeeker, error)
	GetListByPhase(phase []uint) ([]*entity.SendingJobSeeker, error)
	GetSearchListForSendingJobSeekerManagement(agentID uint, freeWord string, staffIDList, senderIDList []uint) ([]*entity.SendingJobSeeker, error) // 送客の進捗一覧ページの絞り込み用

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeeker, error)
}

type SendingJobSeekerStudentHistoryRepository interface {
	/** 汎用系 */
	Create(industry *entity.SendingJobSeekerStudentHistory) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerStudentHistory, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerStudentHistory, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerStudentHistory, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerStudentHistory, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerStudentHistory, error)
}

type SendingJobSeekerWorkHistoryRepository interface {
	/** 汎用系 */
	Create(industry *entity.SendingJobSeekerWorkHistory) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerWorkHistory, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerWorkHistory, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerWorkHistory, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerWorkHistory, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerWorkHistory, error)
}

type SendingJobSeekerExperienceIndustryRepository interface {
	/** 汎用系 */
	Create(experienceIndustry *entity.SendingJobSeekerExperienceIndustry) error
	Update(experienceIndustry *entity.SendingJobSeekerExperienceIndustry) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerExperienceIndustry, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerExperienceIndustry, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerExperienceIndustry, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerExperienceIndustry, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerExperienceIndustry, error)
}

type SendingJobSeekerDepartmentHistoryRepository interface {
	/** 汎用系 */
	Create(departmentHistory *entity.SendingJobSeekerDepartmentHistory) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerDepartmentHistory, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerDepartmentHistory, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerDepartmentHistory, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerDepartmentHistory, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerDepartmentHistory, error)
}

type SendingJobSeekerExperienceOccupationRepository interface {
	/** 汎用系 */
	Create(experienceOccupation *entity.SendingJobSeekerExperienceOccupation) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerExperienceOccupation, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerExperienceOccupation, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerExperienceOccupation, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerExperienceOccupation, error)
	DeleteByID(id uint) error

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerExperienceOccupation, error)
}

type SendingJobSeekerLicenseRepository interface {
	/** 汎用系 */
	Create(industry *entity.SendingJobSeekerLicense) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerLicense, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerLicense, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerLicense, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerLicense, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerLicense, error)
}

type SendingJobSeekerSelfPromotionRepository interface {
	/** 汎用系 */
	Create(industry *entity.SendingJobSeekerSelfPromotion) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerSelfPromotion, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerSelfPromotion, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerSelfPromotion, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerSelfPromotion, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerSelfPromotion, error)
}

type SendingJobSeekerDocumentRepository interface {
	/** 汎用系 */
	Create(document *entity.SendingJobSeekerDocument) error
	Update(document *entity.SendingJobSeekerDocument) error
	UpdateOrigin(document *entity.SendingJobSeekerDocument) error
	UpdateResumeOriginURL(resumeOriginURL string, sendingJobSeekerID uint) error
	UpdateCVOriginURL(cvOriginURL string, sendingJobSeekerID uint) error
	UpdateResumePDFURL(resumePDFURL string, sendingJobSeekerID uint) error
	UpdateCVPDFURL(cvPDFURL string, sendingJobSeekerID uint) error
	UpdateRecommendationOriginURL(recommendationOriginURL string, sendingJobSeekerID uint) error
	UpdateRecommendationPDFURL(recommendationPDFURL string, sendingJobSeekerID uint) error
	UpdateIDPhotoURL(idPhotoURL string, sendingJobSeekerID uint) error
	UpdateOtherDocument1URL(otherDocument1URL string, sendingJobSeekerID uint) error
	UpdateOtherDocument2URL(otherDocument2URL string, sendingJobSeekerID uint) error
	UpdateOtherDocument3URL(otherDocument3URL string, sendingJobSeekerID uint) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) (*entity.SendingJobSeekerDocument, error)
	FindBySendingJobSeekerUUID(sendingJobSeekerUUID uuid.UUID) (*entity.SendingJobSeekerDocument, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerDocument, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerDocument, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerDocument, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerDocument, error)
}

type SendingJobSeekerDesiredIndustryRepository interface {
	/** 汎用系 */
	Create(desiredIndustry *entity.SendingJobSeekerDesiredIndustry) error
	CreateMulti(sendingJobSeekerID uint, desiredIndustryList []entity.SendingJobSeekerDesiredIndustry) error
	Update(desiredIndustry *entity.SendingJobSeekerDesiredIndustry) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerDesiredIndustry, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerDesiredIndustry, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerDesiredIndustry, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerDesiredIndustry, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerDesiredIndustry, error)
}

type SendingJobSeekerDesiredOccupationRepository interface {
	/** 汎用系 */
	Create(desiredOccupation *entity.SendingJobSeekerDesiredOccupation) error
	CreateMulti(sendingJobSeekerID uint, desiredOccupationList []entity.SendingJobSeekerDesiredOccupation) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerDesiredOccupation, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerDesiredOccupation, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerDesiredOccupation, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerDesiredOccupation, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerDesiredOccupation, error)
}

type SendingJobSeekerDesiredWorkLocationRepository interface {
	/** 汎用系 */
	Create(desiredWorkLocation *entity.SendingJobSeekerDesiredWorkLocation) error
	CreateMulti(sendingJobSeekerID uint, desiredWorkLocationList []entity.SendingJobSeekerDesiredWorkLocation) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerDesiredWorkLocation, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerDesiredWorkLocation, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerDesiredWorkLocation, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerDesiredWorkLocation, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerDesiredWorkLocation, error)
}

type SendingJobSeekerDesiredHolidayTypeRepository interface {
	/** 汎用系 */
	Create(desiredHolidayType *entity.SendingJobSeekerDesiredHolidayType) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerDesiredHolidayType, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerDesiredHolidayType, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerDesiredHolidayType, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerDesiredHolidayType, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerDesiredHolidayType, error)
}

// 　送客求職者の開発スキル
type SendingJobSeekerDevelopmentSkillRepository interface {
	/** 汎用系 */
	Create(desiredWorkLocation *entity.SendingJobSeekerDevelopmentSkill) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerDevelopmentSkill, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerDevelopmentSkill, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerDevelopmentSkill, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerDevelopmentSkill, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerDevelopmentSkill, error)
}
type SendingJobSeekerLanguageSkillRepository interface {
	/** 汎用系 */
	Create(desiredWorkLocation *entity.SendingJobSeekerLanguageSkill) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerLanguageSkill, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerLanguageSkill, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerLanguageSkill, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerLanguageSkill, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerLanguageSkill, error)
}

// pcTool
type SendingJobSeekerPCToolRepository interface {
	/** 汎用系 */
	Create(desiredWorkLocation *entity.SendingJobSeekerPCTool) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerPCTool, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerPCTool, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerPCTool, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerPCTool, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerPCTool, error)
}

// desiredComapnyScale
type SendingJobSeekerDesiredCompanyScaleRepository interface {
	/** 汎用系 */
	Create(desiredCompanyScale *entity.SendingJobSeekerDesiredCompanyScale) error
	Delete(sendingJobSeekerID uint) error
	FindBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerDesiredCompanyScale, error)
	GetListByAgentID(agentID uint) ([]*entity.SendingJobSeekerDesiredCompanyScale, error)
	GetListByStaffID(staffID uint) ([]*entity.SendingJobSeekerDesiredCompanyScale, error)
	GetListByIDList(idList []uint) ([]*entity.SendingJobSeekerDesiredCompanyScale, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingJobSeekerDesiredCompanyScale, error)
}

type SendingJobSeekerIsViewRepository interface {
	/** 汎用系 */
	Create(seekerIsView *entity.SendingJobSeekerIsView) error
	Delete(sendingJobSeekerID uint) error
	UpdateIsNotWaitingViewedBySendingJobSeekerID(sendingJobSeekerID uint, isViewed bool) error
	UpdateIsNotUnregisterViewedBySendingJobSeekerID(sendingJobSeekerID uint, isViewed bool) error
	GetIsNotWaitingViewCountByAgentStaffID(agentStaffID uint) (uint, error)
	GetIsNotUnregisterViewCountByAgentStaffID(agentStaffID uint) (uint, error)
}

/****************************************************************************************/
/****************************************************************************************/
// 求職者の興味あり求人(送客時に選択)
type SendingJobSeekerDesiredJobInformationRepository interface {
	/** 汎用系 */
	Create(desiredJobInformaiton *entity.SendingJobSeekerDesiredJobInformation) error
	CreateMulti(sendingJobSeekerID uint, sendingJobInfoIDList []uint) error
	DeleteBySendingJobSeekerID(sendingJobSeekerID uint) error
	GetListBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingJobSeekerDesiredJobInformation, error)
}

/****************************************************************************************/
/****************************************************************************************/
// 送客終了理由
type SendingJobSeekerEndStatusRepository interface {
	/** 汎用系 */
	Create(endStatus *entity.SendingJobSeekerEndStatus) error
}

/****************************************************************************************/
/****************************************************************************************/
// 送客進捗
type SendingPhaseRepository interface {
	/** 汎用系 */
	Create(sendingPhase *entity.SendingPhase) error
	UpdatePhase(id, phase uint) error                                                                                // 進捗を更新
	UpdatePhaseBySendingJobSeekerIDAndSendingEnterpriseID(sendingJobSeekerID, sendingEnterpriseID, phase uint) error // 進捗を更新
	UpdateSendingDate(id uint, sendingDate time.Time) error                                                          // 送客日を更新
	UpdateIsAttended(id uint, isAttended bool) error                                                                 // 送客日を更新
	FindByID(id uint) (*entity.SendingPhase, error)
	FindBySendingJobSeekerIDAndSendingEnterpriseID(sendingJobSeekerID, sendingEnterpriseID uint) (*entity.SendingPhase, error)
	GetSearchListForSendingJobSeekerManagement(agentID uint, freeWord string, staffIDList, senderIDList, sendAgentIDList []uint) ([]*entity.SendingPhase, error) // 送客の進捗一覧ページの絞り込み用
	GetListBySendingJobSeekerID(sendingJobSeekerID uint) ([]*entity.SendingPhase, error)
	GetListByPhaseAndEnterpriseIDList(phase uint, sendingEnterpriseIDList []uint) ([]*entity.SendingPhase, error)
	GetListByAgentIDAndPhaseAndEnterpriseIDList(agentID, phase uint, sendingEnterpriseIDList []uint) ([]*entity.SendingPhase, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingPhase, error)
}

/****************************************************************************************/
/****************************************************************************************/
// 送客応諾後の終了理由
type SendingPhaseEndStatusRepository interface {
	/** 汎用系 */
	Create(endStatus *entity.SendingPhaseEndStatus) error
}
...
/// エージェントと送客求職者のチャット
//
type ChatGroupWithSendingJobSeekerRepository interface {
	/** 汎用系 */
	Create(chatGroupWithSendingJobSeeker *entity.ChatGroupWithSendingJobSeeker) error
	UpdateAgentLastWatchedAt(groupID uint) error
	UpdateAgentLastSendAt(groupID uint) error
	UpdateSendingJobSeekerLastWatchedAtAndSendAt(groupID uint, sendAt time.Time) error
	UpdateSendingJobSeekerLineActive(isActive bool, jobSeekerID uint) error
	FindByID(groupID uint) (*entity.ChatGroupWithSendingJobSeeker, error)
	FindBySendingJobSeekerID(jobSeekerID uint) (*entity.ChatGroupWithSendingJobSeeker, error)
	GetListByAgentID(agentID uint) ([]*entity.ChatGroupWithSendingJobSeeker, error)                             //
	GetNotificationCountByAgentID(agentID uint) (float64, error)                                                //
	GetListByAgentIDAndFreeWord(agentID uint, freeWord string) ([]*entity.ChatGroupWithSendingJobSeeker, error) //

	/** 管理者 */
	GetAll() ([]*entity.ChatGroupWithSendingJobSeeker, error)
}

type ChatMessageWithSendingJobSeekerRepository interface {
	/** 汎用系 */
	Create(chatMessageSendingJobSeeker *entity.ChatMessageWithSendingJobSeeker) error
	GetListByGroupID(groupID uint) ([]*entity.ChatMessageWithSendingJobSeeker, error)
}

// 求職者とのメールを管理する
type EmailWithSendingJobSeekerRepository interface {
	/** 汎用系 */
	Create(emailWithSendingJobSeeker *entity.EmailWithSendingJobSeeker) error
	GetListBySendingJobSeekerID(jobSeekerID uint) ([]*entity.EmailWithSendingJobSeeker, error)
}
...
/// 送客の売上
//
type SendingSaleRepository interface {
	/** 汎用系 */
	Create(sendingSale *entity.SendingSale) error
	Update(sendingSaleID uint, sendingSale *entity.SendingSale) error

	FindByID(sendingSaleID uint) (*entity.SendingSale, error)
	FindByJobSeekerIDAndEnterpriseID(sendingJobSeekerID, sendingEnterpriseID uint) (*entity.SendingSale, error)

	GetListByAgentID(agentID uint) ([]*entity.SendingSale, error)
	GetListBySenderAgentIDForMonthly(senderAgentID uint, startMonth, endMonth string) ([]*entity.SendingSale, error)
	GetListByAgentIDForMonthly(senderAgentID uint, startMonth, endMonth string) ([]*entity.SendingSale, error)

	/** 管理者 */
	GetAll() ([]*entity.SendingSale, error)
	GetAllForMonthly(startMonth, endMonth string) ([]*entity.SendingSale, error)
}

/****************************************************************************************/
/// 送客の売上
//
type SendingShareDocumentRepository interface {
	/** 汎用系 */
	Create(sendingShareDocument *entity.SendingShareDocument) error
	Update(sendingSaleID uint, sendingShareDocument *entity.SendingShareDocument) error
	FindBySendingJobSeekerIDAndSendingEnterpriseID(sendingJobSeekerID, sendingEnterpriseID uint) (*entity.SendingShareDocument, error)
	GetListBySendingEnterpriseID(sendingEnterpriseID uint) ([]*entity.SendingShareDocument, error)
}
